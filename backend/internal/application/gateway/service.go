...
type Input struct {
	...
	// ForcedAccountID pins selection to one account for internal quality
	// probes and Quality Guard recovery. It never accepts public request
	// input, never borrows another credential, and ignores cooldown.
