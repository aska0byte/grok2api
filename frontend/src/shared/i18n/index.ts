  ...
  "zh-CN": {
    translation: {
      ...
      qualityGuard: {
        ...
        enabled: "启用质量守护", enabledHelp: "关闭后不再拦截请求、不再自动探测账号与节点；已有隔离到期自动恢复。",
        guardEnabledToast: "质量守护已启用", guardDisabledToast: "质量守护已关闭",
        disableGuardConfirm: "确定关闭质量守护？将停止拦截请求并暂停自动探测，已有隔离到期自动恢复。",
        disabledBanner: "质量守护已停用：请求不再被拦截，账号与节点的自动探测也已暂停。",
        ...
        samples: {
          tab: "探测样本",
          title: "账号探测样本",
          help: "每次账号探测的回答与思考原文，点击卡片查看全文，可按判定过滤",
          searchPlaceholder: "搜索账号 / 请求 ID / 模型",
          classificationAll: "全部判定",
          kind: "探测方式",
          kindAll: "全部方式",
          kindText: "文本推理",
          kindHTML: "画图 HTML",
          ...
          manualTitle: "人工标记",
          selectSample: "选择样本 {{id}}",
          batchDelete: "批量删除",
          deleteSelectedConfirm: "确定删除选中的 {{count}} 条样本？此操作不可恢复。",
          deleteSample: "删除样本",
          deleteSampleConfirm: "确定删除该样本？此操作不可恢复。",
          accountAction: "账号操作",
          quarantine: "隔离（冷却）",
          quarantineHours: "隔离 {{hours}} 小时",
          quarantineConfirm: "确定将该账号隔离 {{hours}} 小时？期间不参与调度，到期自动恢复。",
          quarantined: "账号已隔离 {{hours}} 小时",
          disableConfirm: "确定禁用该账号？禁用后不参与调度，需手动启用。",
          disabled: "账号已禁用",
          restore: "恢复",
          restoreConfirm: "确定恢复该账号？将重新启用并清除冷却、降智标记与失败计数。",
          restored: "账号已恢复",
          accountActionFailed: "账号操作失败",
          batchQuarantine: "批量隔离",
          batchQuarantineConfirm: "确定将 {{count}} 个账号隔离 {{hours}} 小时？期间不参与调度，到期自动恢复。",
          batchQuarantined: "已隔离 {{count}} 个账号；未找到 {{missing}} 个",
          batchDisable: "批量禁用",
          batchDisableConfirm: "确定禁用 {{count}} 个账号？禁用后不参与调度，需手动启用。",
          batchDisabled: "已禁用 {{count}} 个账号",
          selectAllPages: "选择所有页",
        },
        ...
        degrade: {
          ...
          probeSelected: "探测账号", probeSelectedCount: "探测所选 ({{count}})", probeHelp: "通过账号绑定的长效节点发送推理探测；命中零思考后自动换随机临时代理复核，复核仍命中才冷却 12 小时，冷却后再次命中自动禁用。未绑定账号不探测。", probing: "正在探测账号", probed: "探测完成：共 {{total}}，零思考 {{missing}}，已禁用 {{disabled}}", probeOverturned: "{{count}} 个经临时代理复核通过（绑定节点/IP 嫌疑）", probeFailed: "探测失败", probeFailedCount: "失败 {{count}}（{{reason}}）",
    ...
    translation: {
      ...
      qualityGuard: { title: "Quality guard", description: "Monitor Grok egress quality and quarantine anomalous nodes automatically.", overview: "Quality guard overview",
        ...
        samples: {
          ...
          roundConfirm: "Recheck",
          sourceManual: "Manual",
          sourceScheduled: "Scheduled",
          loadFailed: "Failed to load probe samples",
          empty: "No probe samples yet. Run an account probe and samples will appear here",
          detailTitle: "Probe sample detail",
          firstToken: "First token {{ms}}ms",
          duration: "Duration {{ms}}ms",
          response: "Response",
          reasoning: "Reasoning",
          truncated: "truncated",
          noOutput: "(no visible output)",
          notJudged: "Not judged",
          selectAll: "Select page",
          manualFilter: "Manual mark",
          manualAll: "All flags",
          manual: {
            none: "Unmarked",
            suspected: "Suspect degraded",
            normal: "Looks normal",
            clear: "Clear mark",
          },
          manualTitle: "Manual mark",
          selectSample: "Select sample {{id}}",
          batchDelete: "Delete selected",
          deleteSelectedConfirm: "Delete {{count}} selected samples? This cannot be undone.",
          deleteSample: "Delete sample",
          deleteSampleConfirm: "Delete this sample? This cannot be undone.",
          accountAction: "Account actions",
          quarantine: "Isolate (cool down)",
          quarantineHours: "Isolate {{hours}}h",
          quarantineConfirm: "Isolate this account for {{hours}} hours? It leaves rotation and recovers automatically.",
          quarantined: "Account isolated for {{hours}} hours",
          disableConfirm: "Disable this account? It stays out of rotation until manually enabled.",
          disabled: "Account disabled",
          restore: "Restore",
          restoreConfirm: "Restore this account? It will be re-enabled with cooldown, strike marker, and failure backoff cleared.",
          restored: "Account restored",
          accountActionFailed: "Account action failed",
          batchQuarantine: "Batch isolate",
          batchQuarantineConfirm: "Isolate {{count}} accounts for {{hours}} hours? They leave rotation and recover automatically.",
          batchQuarantined: "Isolated {{count}} accounts; {{missing}} not found",
          batchDisable: "Batch disable",
          batchDisableConfirm: "Disable {{count}} accounts? They stay out of rotation until manually enabled.",
          batchDisabled: "Disabled {{count}} accounts",
        ...
        degrade: {
          ...
          probeSelected: "Probe accounts", probeSelectedCount: "Probe selected ({{count}})", probeHelp: "Send a reasoning probe through each account's bound long-lived node; a missing-thinking hit is retested once via a random temporary proxy before the strike applies — the first confirmed hit cools the account for 12 hours and a second hit after the cooldown disables it. Unbound accounts are skipped.", probing: "Probing accounts", probed: "Probe completed: {{total}} total, {{missing}} missing thinking, {{disabled}} disabled", probeOverturned: "{{count}} passed the tmp-proxy retest (bound node/IP suspect)", probeFailed: "Probe failed", probeFailedCount: "{{count}} failed ({{reason}})",
...
Object.assign(resources.en.translation.settings.egress as unknown as Record<string, string>, {
  ...
  imported: "Proxy import completed: {{imported}} imported, {{skipped}} skipped, {{replaced}} replaced", tested: "Proxy test completed: {{healthy}} healthy, {{unhealthy}} unhealthy", testedPartial: "Connectivity probe partially completed: {{healthy}} healthy, {{unhealthy}} unhealthy, {{failed}} not completed",
  ...
  tabLongTerm: "Long-term proxies", tabTemporary: "Temporary proxies", autoBind: "Auto-bind idle nodes", autoBindDone: "Account binding completed: {{assigned}} assigned, {{rebalanced}} balanced, {{unplaced}} unplaced, {{released}} released", autoBindConfirmTitle: "Auto-bind accounts", autoBindConfirmDescription: "Assigns unbound and auto-mode accounts to every enabled long-term node, including unprobed, unhealthy, or cooling-down nodes; disabled nodes are skipped.", autoBindConfirmNote: "If a bound node turns out to be broken, the request path fails over to another node; periodic probing repairs node states over time.", autoBindStatTotal: "Long-term nodes", autoBindStatAssigned: "Assigned", autoBindStatRebalanced: "Migrated", autoBindStatReleased: "Released", autoBindStatUnplaced: "Unplaced", autoBindStatCooldown: "Cooling down", autoBindStatMode: "Mode", autoBindResultTitle: "Auto-bind result", autoBindResultSummary: "{{assigned}} assigned, {{rebalanced}} migrated, {{released}} released, {{unplaced}} unplaced.", autoBindUnplacedNote: "Some accounts remain unplaced: usually no eligible long-term node or node capacity is full.", nodeAccountsTitle: "Accounts bound to {{name}}", nodeAccountsDescription: "{{count}} accounts reserve capacity on this node.", nodeAccountsAccount: "Account", nodeAccountsEmpty: "No accounts are bound to this node yet.", nodeAccountsManual: "Manual", nodeAccountsAuto: "Auto", usage: "Usage", usageProduction: "Long-term (production)", usageProbe: "Temporary (probe)", usageHelp: "Temporary proxies are reserved for account quality probing and are never bound to production accounts.", usageFixedHelp: "The usage type cannot be changed after creation.", probeNodeLimit: "Probe node limit", probeNodeLimitHelp: "When probe imports exceed this limit, the oldest nodes are evicted; 0 means unlimited.",
...
Object.assign(resources["zh-CN"].translation.accounts as unknown as Record<string, unknown>, {
  qualityProbeSelected: "降智探测（所选）",
  qualityProbeAll: "降智探测（全部）",
  qualityProbeTitle: "账号降智探测",
  qualityProbeDescription: "对账号绑定的长效代理发送真实推理请求，检测是否被降智；命中后自动换临时代理复核。",
  qualityProbeTargetSummary: "将探测 {{count}} 个账号；跳过 {{skipped}} 个（禁用或未绑定长效节点）",
  qualityProbeSelectedNote: "逐个探测所选账号；已禁用、冷却中、风控标记的账号同样会发送，便于复核处理。",
  qualityProbeFilteredNote: "将按账号页当前筛选条件探测（仍会跳过禁用或未绑定长效节点的账号）。",
  qualityProbePreparing: "正在加载账号 {{loaded}}/{{total}}…",
  qualityProbePreparingTimeout: "加载账号列表超时，请重试",
  qualityProbeCancelled: "已取消：本次完成 {{done}}/{{total}} 个探测",
  qualityProbeConcurrency: "并发数",
  qualityProbeConcurrencyHelp: "同时探测的账号数量（1-4，服务端上限 4）。探测在服务端后台执行，占用一条连接。",
  qualityProbeKind: "探测方式",
  qualityProbeKindText: "文本推理（降智判定）",
  qualityProbeKindHTML: "画图 HTML（视觉+速度）",
  qualityProbeKindHelp: "文本推理用于降智判定；画图 HTML 只看渲染效果和生成速度，不影响降智状态。",
  qualityProbeStart: "开始探测",
  qualityProbeStop: "停止",
  qualityProbeProgress: "已探测 {{done}} / {{total}}",
  qualityProbeStatMissing: "命中降智",
  qualityProbeStatDisabled: "已禁用",
  qualityProbeStatOverturned: "复核推翻",
  qualityProbeStatFailed: "失败",
...
Object.assign(resources.en.translation.accounts as unknown as Record<string, unknown>, {
  qualityProbeSelected: "Quality probe (selected)",
  qualityProbeAll: "Quality probe (all)",
  qualityProbeTitle: "Account quality probe",
  qualityProbeDescription: "Sends a real reasoning request through each account's bound long-lived proxy to detect degraded intelligence; hits are re-checked through a temporary proxy.",
  qualityProbeTargetSummary: "Will probe {{count}} accounts; skipping {{skipped}} (disabled or unbound)",
  qualityProbeSelectedNote: "Probes each selected account; disabled, cooling, and flagged accounts are probed too so you can re-verify them.",
  qualityProbeFilteredNote: "Probes accounts matching the current page filters (disabled or unbound accounts are still skipped).",
  qualityProbePreparing: "Loading accounts {{loaded}}/{{total}}…",
  qualityProbePreparingTimeout: "Timed out loading the account list; please retry",
  qualityProbeCancelled: "Cancelled: {{done}}/{{total}} probes completed",
  qualityProbeConcurrency: "Concurrency",
  qualityProbeConcurrencyHelp: "Accounts probed simultaneously (1-4, server cap 4). Probes run server-side over a single connection.",
  qualityProbeKind: "Probe kind",
  qualityProbeKindText: "Text reasoning (verdict)",
  qualityProbeKindHTML: "HTML card (visual + speed)",
  qualityProbeKindHelp: "Text reasoning drives the missing-thinking verdict; the HTML card only shows rendering and speed and never changes strike state.",
  qualityProbeStart: "Start probing",
  qualityProbeStop: "Stop",
  qualityProbeProgress: "Probed {{done}} / {{total}}",
  qualityProbeStatMissing: "Missing thinking",
  qualityProbeStatDisabled: "Disabled",
  qualityProbeStatOverturned: "Overturned",
  qualityProbeStatFailed: "Failed",
